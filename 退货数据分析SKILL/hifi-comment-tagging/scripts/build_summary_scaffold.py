...
def summarize(rows):
    ...
    return valid_rows, tagged_rows, chain_counter, type_counter, subissue_counter, severity_counter, macro_counter
...
def main():
    ...
    valid_rows, tagged_rows, chain_counter, type_counter, subissue_counter, severity_counter, macro_counter = summarize(rows)
